                                ...
                                <form method="post" action="{{ route('courier.store') }}" enctype='multipart/form-data'>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <textarea class="form-control" type="text" placeholder="PRODUCT DETAILS" name="product_detail" /></textarea>
                                            @if($errors->has('product_detail'))
                                                    <div class="error text-danger">{{ $errors->first('product_detail') }}</div>
                                            @endif
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label for="firstName1">PRODUCT WEIGHT</label>
                                            <input class="form-control" type="text" placeholder="PRODUCT WEIGHT" name="product_weight" />
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <textarea class="form-control" type="text" placeholder="FROM ADDRESS " name="from_address" /></textarea>
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <textarea class="form-control" type="text" placeholder="DELIVERY ADDRESS" name="delivery_address" /></textarea>
